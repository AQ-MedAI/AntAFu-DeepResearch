...
## 🔥 News
* **[2026-05]** 🎉 We have proposed **SlimSearcher**. an efficiency-aware training framework for web agents that reduces tool-call rounds by 17%–58% while maintaining or even improving accuracy.[Paper is available here](https://arxiv.org/abs/2606.07074).
